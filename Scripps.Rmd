...
.left-column[
 ...
 ### .nord4.bold[Strong effect on] .nord13.bold[number of reads]
]
...
### .center[ Can we get .bold[quantitative] information from metabarcoding by transforming the data?]
...
.content-box-blue[
.nord1[
## But applying the same threshold across the board
...
---
```{r,echo=F, fig.align='right'}
knitr::include_graphics("images/SimulationFigure_Main_3varyPCRsamples.jpeg")
```
